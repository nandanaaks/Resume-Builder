      ...
      <AppBar position="static" style={{backgroundColor:'purple'}}>
        <Toolbar>
          <IconButton
            ...
            sx={{ mr: 2 }}
          >
            <img width={'40px'} src="https://pngimg.com/d/cv_PNG30.png" alt="logo" />
          </IconButton>
          <Typography variant="h6" component="div" sx={{ flexGrow: 1 }}>
            <Link to={"/"} className='text-light text-decoration-none'>rBuilder</Link>
          </Typography>
          <Tooltip title={intro}>
            <Button sx={{fontWeight:'600',fontFamily:'Playfair Display", serif'}} color="inherit">About Us</Button></Tooltip>
        </Toolbar>
      </AppBar>
    </Box>
  )
