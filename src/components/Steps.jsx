    ...
    switch (stepCount) {
      ...
      case 2: return (
        <div>
          ...
          <div className="d-flex row p-3">
            ...
            <TextField id="standard-basic-year" label="Pear of Passout" variant="standard" />
          </div>
        </div>
      )
      case 3: return (
        <div>
          ...
          <div className="d-flex row p-3">
            ...
            <TextField id="standard-basic-jcompany" label="Company Name" variant="standard" />
      ...
      case 5: return (
        <div>
          ...
          <div className="d-flex row p-3">
            <TextField id="standard-basic-summary" label="Write a short summary of yourself" multiline rows={4} defaultValue={'Motivated Web Development Enthusiast with a solid grasp of HTML, CSS, JavaScript, and responsive design principles. Familiar with front-end frameworks like React.js and version control using Git. Quick learner with a passion for building clean, user-friendly interfaces and continuously expanding technical skills.'} variant="standard" />
          </div>
        </div>
      )
      default: return null
